...
/**
 * Listens to bukkit if there is a WorldEdit plugin enabled.
 *
 * @author Michael Hohl
 */
public class WorldEditPluginListener extends ServerListener {
     ...
     */
    public WorldEditPluginListener(MyResidencePlugin plugin) {
        this.plugin = plugin;
    }

    /**
     * Called when an plugin gets enabled.
     *
    ...
    /**
     * Called when an plugin gets disabled.
     *
     * @param event the occurred event.
     */
    @Override
